...
//                                                $state.go(ngAAConfig.signinState);
                                                                        $state.go('dashboard');
                                                                        $rootScope.message = "You don't have permissions for that.";
    ...
    (function () {
        ...
        angular
                .module('ngAA')
                .factory('ngAAUser', ['$q', '$http', 'ngAAToken', 'ngAAConfig', 'ngAAUtils','$window','$location', function ($q, $http, ngAAToken, ngAAConfig, ngAAUtils,$window,$location) {
                        var $user = {};
...
//                                        $scope.user = {};
                                    ...
                                    .catch(function (error) {
                                        ...
                                        $scope.error_exist_text = error.data.error;
