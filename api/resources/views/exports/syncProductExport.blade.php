            ...
            <table>
                ...
                @foreach($products as $key => $value)
                    <tr>
                        ...
                        <td>{{$value[29]}}</td>
                        <td>{{$value[30]}}</td>
                        <td>@if(isset($value[31]) && $value[31] !== '') {{ $value[31]->format('Y-m-d H:i:s') }} @endif</td>
                        <td>@if(isset($value[32]) && $value[32] !== '') {{ $value[32] }} @endif</td>
                        <td>@if(isset($value[33]) && $value[33] !== '') {{ $value[33] }} @endif</td>
                        <td>@if(isset($value[34]) && $value[34] !== '') {{ $value[34] }} @endif</td>
                        <td>@if(isset($value[35]) && $value[35] !== '') {{ $value[35]->format('Y-m-d H:i:s') }} @endif</td>
