(function(e) {
    ...
    var i = function(e, t) {
        if ("jQuery" in window) {
            ...
            e = angular.element(e);
            return "getComputedStyle" in window ? window.getComputedStyle(e[0])[t] : e.css(t)
        }
    };
    ...
    angular.module(t, ["ngMaterial"]).provider("mdcDatetimePickerDefaultLocale", function() {
        this.locale = "en";
        this.$get = function() {
            return this.locale
        };
        this.setDefaultLocale = function(e) {
            this.locale = e
        }
    }).directive("mdcDatetimePicker", ["$mdDialog", function(t) {
        return {
            restrict: "A",
            require: "ngModel",
            scope: {
            ...
            link: function(a, i, s, c) {
                ...
                if (angular.isString(a.currentDate) && a.currentDate !== "") {
                    a.currentDate = e(a.currentDate, a.format)
                }
                if (c) {
    ...
    n.prototype = {
        ...
        currentNearest5Minute: function() {
            var t = this.currentDate || e();
            var a = 5 * Math.round(t.minute() / 5);
            if (a >= 60) {
                a = 55
            }
            return e(t).minutes(a)
        },
        initDates: function() {
            var t = this;
            var a = function(a, i) {
                ...
                if (angular.isDefined(a) && a !== null && a !== "") {
                    if (angular.isString(a)) {
                        if (typeof t.params.format !== "undefined" && t.params.format !== null) {
                            r = e(a, t.params.format).locale(t.params.lang)
                        } else {
                            r = e(a).locale(t.params.lang)
                        }
                    } else {
                        if (angular.isDate(a)) {
                            var n = a.getTime();
                            r = e(n, "x").locale(t.params.lang)
            ...
            this.currentDate = a(this.params.currentDate, e());
        ...
        isBeforeMaxDate: function(t, a, i) {
            var r = true;
        ...
        selectDate: function(t) {
            if (t) {
                ...
                this.calendarStart = e(this.currentDate);
        ...
        incrementYear: function(e) {
            if (e === 1 && this.isNextYearVisible()) {
                this.selectDate(this.currentDate.add("year", e))
            }
            if (e === -1 && this.isPreviousYearVisible()) {
                this.selectDate(this.currentDate.add("year", e))
            }
        },
        isPreviousMonthVisible: function() {
            return this.calendarStart && this.isAfterMinDate(e(this.calendarStart).startOf("month"), false, false)
        },
        isNextMonthVisible: function() {
            return this.calendarStart && this.isBeforeMaxDate(e(this.calendarStart).endOf("month"), false, false)
        },
        isPreviousYearVisible: function() {
            return this.calendarStart && this.isAfterMinDate(e(this.calendarStart).startOf("year"), false, false)
        },
        isNextYearVisible: function() {
            return this.calendarStart && this.isBeforeMaxDate(e(this.calendarStart).endOf("year"), false, false)
        },
        isHourAvailable: function(t) {
            var a = e(this.currentDate);
            a.hour(this.convertHours(t)).minute(0).second(0);
            return this.isAfterMinDate(a, true, false) && this.isBeforeMaxDate(a, true, false)
        },
        isMinuteAvailable: function(t) {
            var a = e(this.currentDate);
            a.minute(t).second(0);
    ...
    angular.module(t).directive("mdcDatetimePickerCalendar", [function() {
        var t = e(),
            a = 1900,
            i = 2100,
            r = (i - a + 1) * 12,
        ...
        return {
            ...
            controller: ["$scope", function(t) {
                ...
                i.getItemAtIndex = function(t) {
                    var i = (t + 1) % 12 || 12;
                    var r = a + Math.floor(t / 12);
                    var s = e(n.currentDate).year(r).month(i);
                    return m(s)
                };
                i.topIndex = l(n.currentDate) - i.months[0];
                t.$watch(function() {
                    return n.currentDate ? n.currentDate.format("YYYY-MM") : ""
                }, function(t, a) {
                    if (t != a) {
                        var r = e(t, "YYYY-MM");
                        var n = l(r);
                ...
                var m = function(t) {
                    var a = {};
                    if (t !== null) {
                        a.name = t.format("MMMM YYYY");
                        var r = e(t).locale(n.params.lang).startOf("month").hour(t.hour()).minute(t.minute());
                        var s = r.format("d");
                        a.days = [];
                        for (var c = r.date(); c <= r.daysInMonth(); c++) {
                            ...
                            a.days.push(e(r).locale(n.params.lang).date(c))
                        }
                        var u = 7,
                            d = [],
                            m = Math.ceil(a.days.length / u);
                        for (var p = 0; p < m; p++) {
                            d.push(a.days.slice(p * u, (p + 1) * u))
                        }
                        a.days = d;
                        return a
                    }
                ...
                i.toDay = function(t) {
                    return e(parseInt(t), "d").locale(n.params.lang).format("dd").substring(0, 1)
                };
                i.isInRange = function(t) {
                    return n.isAfterMinDate(e(t), false, false) && n.isBeforeMaxDate(e(t), false, false)
                };
                i.selectDate = function(t) {
                    if (t) {
                        if (i.isSelectedDay(t)) {
                            return n.ok()
                        }
                        n.selectDate(e(t).hour(i.date.hour()).minute(i.date.minute()))
                    }
                };
                i.isSelectedDay = function(e) {
                    return e && i.date.date() === e.date() && i.date.month() === e.month() && i.date.year() === e.year()
                }
            }],
            template: '<md-virtual-repeat-container md-top-index="cal.topIndex" class="months">' + '<div md-virtual-repeat="idx in cal.months" md-start-index="cal.topIndex" md-item-size="' + n + '">' + '     <div mdc-datetime-picker-calendar-month idx="idx"></div>' + "</div>" + "</md-virtual-repeat-container>"
        }
    }]).directive("mdcDatetimePickerCalendarMonth", ["$compile", function(e) {
        var t = function(t, a) {
            var i = angular.element(t[0].querySelector("tbody"));
            var r = a.cal,
                n = a.month;
            i.html("");
            n.days.forEach(function(e, t) {
                ...
                e.forEach(function(e, i) {
                    ...
                    if (e) {
                        ...
                        s.addClass("dtp-select-day").html(e.format("D"));
                        n.append(s)
                    }
                    a.append(n)
                });
        ...
        return {
            ...
            link: function(e, a, i, r) {
                e.cal = r;
                e.month = r.getItemAtIndex(parseInt(e.idx));
                t(a, e);
                e.$watch(function() {
                    return e.idx
                }, function(i, n) {
    ...
    angular.module(t).directive("mdcDtpNoclick", function() {
        return {
            link: function(e, t) {
    ...
    angular.module(t).directive("mdcDatetimePickerClock", [function() {
        ...
        return {
            ...
            link: function(e, t, a) {
                ...
                var c = function() {
                    var a = angular.element(t[0].querySelector(".dtp-picker-clock")),
                    ...
                    var p = parseInt(i(a, "marginLeft").replace("px", "")) || 0;
                    var h = parseInt(i(a, "marginRight").replace("px", "")) || 0;
                    var f = o - (p + h + d + m);
                    a.css("width", f + "px");
                    ...
                    for (var b = 0; b < 12; ++b) {
                        ...
                        var I = x * Math.cos(Math.PI * 2 * (b / 12));
                        var T = {
                            left: M + A + v / 2 - (v + g),
                            top: M - I - k / 2 - (D + k),
                            value: r ? b * 5 : b
                        ...
                        if (r) {
                            T.display = T.value < 10 ? "0" + T.value : T.value
                        } else {
                            if (n.params.shortTime) {
                                T.display = b === 0 ? 12 : b
                            } else {
                                T.display = n.isPM() ? b + 12 : b
                            }
                        }
                        y.push(T)
                    }
                    ...
                    u();
                    a.css("height", f + "px");
                    var w = t[0].querySelector(".dtp-clock-center");
                    var S = w.offsetWidth / 2 || 7.5,
                        Y = w.offsetHeight / 2 || 7.5;
                    var H = M / 1.8;
                    var V = M / 1.5;
                    angular.element(t[0].querySelector(".dtp-hour-hand")).css({
                        left: M + g * 1.5 + "px",
                        height: H + "px",
                        marginTop: M - H - v + "px"
                    }).addClass(!r ? "on" : "");
                    angular.element(t[0].querySelector(".dtp-minute-hand")).css({
                        left: M + g * 1.5 + "px",
                        height: V + "px",
                        marginTop: M - V - v + "px"
                    }).addClass(r ? "on" : "");
                    angular.element(w).css({
                        left: M + v + g - S + "px",
                        marginTop: M - g / 2 - Y + "px"
                    });
                    l()
                };
                var l = function() {
                    ...
                    var a = e.hour();
                    var i = e.minute();
                    o(angular.element(t[0].querySelector(".dtp-hour-hand")), 360 / 12 * a);
                    var r = 360 / 60 * (5 * Math.round(i / 5));
                    o(angular.element(t[0].querySelector(".dtp-minute-hand")), r)
                };
                var o = function(e, t) {
                ...
                var u = function() {
                    ...
                    e.currentValue = r ? t.minute() : t.hour() % 12
                };
                e.$watch(function() {
                    var e = n.currentNearest5Minute();
                    return e ? e.format("HH:mm") : ""
                }, function(e) {
                    u();
                    l()
                });
                ...
                if (!n.params.shortTime) {
                    e.$watch("picker.meridien", function() {
                        if (!r) {
                            if (e.points) {
                                var t = d(n.isPM(), angular.copy(e.points));
                                e.points = t
                            }
                        }
                    })
                ...
                e.setTime = function(t) {
                    ...
                    if (!r) {
                        n.currentDate.hour(n.isPM() ? t + 12 : t)
                    } else {
                        n.currentDate.minute(t)
                    }
                    n.currentDate.second(0)
                };
                e.pointAvailable = function(e) {
                    return r ? n.isMinuteAvailable(e.value) : n.isHourAvailable(e.value)
                };
                var m = e.$watch(function() {
                    return t[0].querySelectorAll("div").length
                }, function() {
                    c();
                    m()
                })
