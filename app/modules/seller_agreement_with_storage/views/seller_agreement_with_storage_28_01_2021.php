<div id="login" class="flex-scrollable" layout="column" ms-scroll>
    <div id="login-form-wrapper" layout="column" layout-align="center center">
        <div id="login-form" class="md-whiteframe-8dp">
            <img src="../../../../assets/images/long_logo.png" height="100" style="margin-bottom: 20px;">
            <div class="title">CONSIGNMENT AGREEMENT with STORAGE</div>
            <form name="SellerAgreementForm" novalidate method="POST" ng-submit="SaveSellerAgreement(SellerAgreementForm.$valid)" autocomplete="off">
                <p>
                    <b>
                ...
                <p>
                    <b>
                        If an Item(s) is categorized as “small” in the Pricing Proposal and is not in storage with TLV then
                        Consignor is willing to drop it off at The Local Vault’s office in Cos Cob, CT within a week from
                        the date the Item was purchased by the “Buyer”. Please note that a $25 service fee will be charged
                        should the Consignor not drop off the Item(s) within this 1 week period. 
                    </b>
                </p>
                <p>
                    For larger Item(s) Consignor will allow pick-up to take place at the location designated below
                    <b>Should Item(s) not be in storage with TLV please indicate below the location where the larger Item(s) will be available for pick-up:</b>
                </p>
                ...
                <ol style="list-style: bold;">
                    ...
                    <li>
                        Item(s) made available for sale through TLV include the “Make-an-Offer” functionality. Makean-Offer allows prospective buyers to “Offer” to buy an Item at a price below the Advertised
                        ...
                        <br>
                        <b>
                            For any Item(s) that IS in Storage with TLV any Offer(s) received on the Item(s) after
                            month 4 of the sale will be managed by TLV and TLV has the sole authority to accept,
                            reject, or counter the Offer(s).
                        </b>
                    </li>
                    <li>
                        When Buyer takes possession of the Item(s) the sale is considered “Completed”. When the sale
                        of an Item(s) is Completed TLV shall retain a commission as a percentage of the “Sale Price” for
                        its services. The Sale Price is the price paid by the Buyer for the Item(s) less any transaction
                        fees. The “Net Sale Proceeds” to be received by the Consignor is calculated as the Sale Price
                        less TLV commission. The Net Sale Proceeds will be sent to the Consignor at the address
                        ...
                        <br>
                        For Items that ARE in Storage TLV’s commission will be 50% of the Sale Price unless
                        otherwise agreed between Consignor and TLV.
                    </li>
                    <li>
                        This Consignment Agreement is for an “Initial Term” of 6-months.
                        <br>
                        For any Item(s) that is NOT in Storage, prior to the end of this Initial Term TLV will notify the
                        Consignor via email that an unsold Item(s) will be removed from the site unless Consignor
                        expresses a desire to extend the sale. If the Consignor wishes to continue to list their unsold
                        Item(s) the sale will be extended for an additional 2-month term at the Advertised Price.
                        Subsequent 2-month extensions will be determined via the same process at the end of each 2-
                        month term.
                        <br>
                        <b>
                            For any Item(s) that IS in Storage, the Consignor may choose to pick up the Item(s) from
                            Storage and end the Initial Term. For any Item(s) where the Consignor chooses to leave
                            the Item(s) in Storage TLV shall have the right to continue the sale on thelocalvault.com or
                            auction the Item(s) via TLV Auctions. For any Item(s) which are sold via TLV Auctions
                            the Consignor will receive Net Sale Proceeds equal to 80% of the Hammer Price at which
                            the Item sells.
                        </b>
                    </li>
                    <li>
